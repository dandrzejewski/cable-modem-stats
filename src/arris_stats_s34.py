...
def parse_json(json):
  ...
  logging.info('Parsing JSON for modem model s34')
...
def hnap_auth_header(private_key: str, soap_action: str) -> str:
  ...
  logging.debug("Private key: " + private_key)

  # wierd... shrug. just following the javascript impl.
  current_time = int(time.time() * 1000) 
  cur_time_millis = str(current_time % 2000000000000)
